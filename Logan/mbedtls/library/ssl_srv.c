...
static int ssl_parse_client_hello_v2( mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_BUF( 4, "du header", buf, 5 );
     ...
     *   ..  .  ..   challenge
     */
    MBEDTLS_SSL_DEBUG_BUF( 4, "du contents", buf, n );
...
read_record_header:
     ...
     * ClientHello, which doesn't use the same du layer format.
     */
#if defined(MBEDTLS_SSL_RENEGOTIATION)
    if( ssl->renego_status == MBEDTLS_SSL_INITIAL_HANDSHAKE )
#endif
    ...
    MBEDTLS_SSL_DEBUG_BUF( 4, "du header", buf, mbedtls_ssl_hdr_len( ssl ) );
     ...
     *     3  .   11  DTLS: epoch + du sequence number
     *     3  .   4   message length
     */
        ...
        )
    {
        ...
        {
            MBEDTLS_SSL_DEBUG_MSG( 1, ( "replayed du, discarding" ) );
    ...
    MBEDTLS_SSL_DEBUG_BUF( 4, "du contents", buf, msg_len );
