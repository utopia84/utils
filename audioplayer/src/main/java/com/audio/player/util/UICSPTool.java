...
public class UICSPTool {
    ...
    private static SimpleArrayMap<String, UICSPTool> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;

    /**
     * 获取 SP 实例
     *
     * @return {@link UICSPTool}
     */
     ...
     * @return {@link UICSPTool}
     */
    public static UICSPTool getInstance(String spName) {
        if (isSpace(spName)) spName = "spUtils";
        UICSPTool spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            spUtils = new UICSPTool(spName);
            SP_UTILS_MAP.put(spName, spUtils);
        }
        return spUtils;
    }

    private UICSPTool(final String spName) {
        sp = UICAppTool.getApplicationContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
